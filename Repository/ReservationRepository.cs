...
namespace Repository
{
    public class ReservationRepository : IReservationRepository
    {
        ...
        public Reservation GetReservationByIndex(int index) => ReservationDAO.GetReservationByIndex(index);
        public void AddReservationDetail(ReserveDetail reserveDetail) => ReservationDAO.AddReservationDetail(reserveDetail);
    }
}
