...
namespace DataAcess
{
    public class ReservationDAO
    {
        ...
        public static void AddReservationDetail(ReserveDetail ReservationDetail)
        {
            ...
            try
            {
                using (var context = new restaurant2Context())
                {
                    context.ReserveDetails.Add(ReservationDetail);
                    context.SaveChanges();
                }
            }
            catch (Exception ex)
        ...
        public static Reservation GetReservationByIndex(int index)
        {
            try
            {
